...
driver.find_element(By.XPATH, "//input[@placeholder='Enter generator name']").send_keys("Nisha Das")
driver.find_element(By.XPATH, "//input[@placeholder='Enter internal account number']").send_keys("74392584027439")
...
driver.find_element(By.ID, "serviceAddress-street").send_keys("Swami shibananda road,barasat")
...
driver.find_element(By.XPATH, "//input[@placeholder='Email Address']").send_keys("nishadas0453@gmail.com")
driver.find_element(By.XPATH, "//input[@placeholder='(123) 456-7890']").send_keys("7439258402")
#latitude & longitutde
time.sleep(2)
